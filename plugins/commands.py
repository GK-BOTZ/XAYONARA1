...
from info import TRY_AGAIN_BTN, REQUEST_TO_JOIN_MODE, CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, SUPPORT_CHAT, MAX_B_TN, VERIFY, SHORTLINK_API, SHORTLINK_URL, TUTORIAL, IS_TUTORIAL, PREMIUM_USER
...
async def start(client, message):
    ...
    if AUTH_CHANNEL and await is_req_subscribed and not await is_subscribed(client, message):
        try:
